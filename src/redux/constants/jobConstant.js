...
export const JOB_BY_COMPANYID_REQUEST = "JOB_BY_COMPANYID_REQUEST";
export const JOB_BY_COMPANYID_SUCCESS = "JOB_LOAD_SINGLE_SUCCESS";
export const JOB_BY_COMPANYID_FAIL = "JOB_BY_COMPANYID_FAIL";
export const JOB_BY_COMPANYID_RESET = "JOB_BY_COMPANYID_RESET";
