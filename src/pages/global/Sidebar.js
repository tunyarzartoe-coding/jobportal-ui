...

                            {
                                collapsed ?
                                    ...
                                    <Box sx={{ display: "flex", justifyContent: "center" }}>
                                        <img style={{ width: "100px", heigth: "150px", textAlign: "center", transition: "all ease-out .5s",borderRadius:"50%" }} src={logoDashboard} alt="logo dashboard" />
                                    </Box>
                            }
                        ...
                        >
                            {
                                userInfo && userInfo.role === 1 ?
                                    <>
                                        ...
                                        <MenuItem component={<Link to="/admin/companies" />} icon={<BusinessIcon />}> Company </MenuItem>
